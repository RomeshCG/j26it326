  ...
  return (
    <div className="flex min-h-screen bg-[#0A0A0A] text-slate-200">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 overflow-y-auto max-h-screen">
        <div className="w-full max-w-xl bg-[#161616] border border-slate-800 rounded-2xl p-8 shadow-2xl my-8">
          ...
          {isSuccess ? (
            <div className="text-center py-12 px-6 flex flex-col items-center animate-in fade-in zoom-in duration-300">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Workspace Claimed</h2>
              <p className="text-slate-400 mb-8">Creating your initial configuration. This takes about 3 seconds.</p>
            ...
            <>
              <h2 className="text-2xl font-bold text-white mb-2">Claim your workspace</h2>
              <p className="text-slate-400 text-sm mb-8">Quickly register your institution to get started.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      required
                      className="w-full bg-[#0A0A0A] border border-slate-700 rounded-lg px-4 py-2.5 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-colors"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-2 relative">
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={handleInputChange}
                        required
                        className="w-full bg-[#0A0A0A] border border-slate-700 rounded-lg px-4 py-2.5 text-white appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-colors"
                      >
                  ...
                  <div className="space-y-2 relative">
                    <label className="text-sm font-medium text-slate-300">District (HQ)</label>
                    <div className="relative">
                      <select
                        name="district"
                    ...
                    <div className="pt-1">
                      <div className="flex gap-1 mb-1">
                        {[0, 1, 2, 3].map((i) => (
                          <div 
                            key={i} 
                            className={`h-1 w-full rounded-full ${i < strength ? strengthColors[strength] : "bg-slate-800"}`} 
                          />
                        ))}
                      </div>
                      <div className="text-xs text-slate-400 text-right">{strengthLabels[strength]}</div>
                    </div>
                  )}
                </div>
